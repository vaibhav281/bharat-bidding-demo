...
export default function HomeVisionNew() {
  ...
  const renderDescription = (
    ...
    >
      ...
      {/* <Typography variant="overline" component="div" sx={{ color: 'text.disabled' }}>
        At BharatBidding, our Vision is to provide businesses with a reliable and efficient platform to outsource products and services. We believe in building long-term relationships with our clients and providing them with the best possible service.
      </Typography> */}
