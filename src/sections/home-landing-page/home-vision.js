      ...
      <Container component={MotionViewport}>
        ...
        <m.div variants={varFade().inUp}>
          <Typography variant="h3" sx={{ textAlign: 'center', maxWidth: 800, mx: 'auto' }}>
            We help businesses find the right products to meet their needs. Our platform connects businesses with suppliers from around the world to find the best products at the best prices.
          </Typography>
        </m.div>
      </Container>
    </Box>
