        ...
        <Box sx={{ pb: 0, position: 'relative' }}>
          <Card sx={{ px: { xs: 1, sm: 1, md: 8 }, py: 3 }}>
            ...
            <Box sx={{ my: 2, pl: 0, }}>
              ...
              <Typography variant="body2">
                This privacy notice for (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;), describes how and why we might collect, store, use, and share (&ldquo;process&rdquo;) your information when you use our services (&ldquo;Services&rdquo;), such as when you:
              </Typography>
