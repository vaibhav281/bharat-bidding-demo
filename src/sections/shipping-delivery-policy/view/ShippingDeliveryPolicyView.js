...
import { Container, Box, Card, Typography, List, ListItem, } from '@mui/material';
          ...
          <Card sx={{ px: { xs: 1, sm: 1, md: 8 }, py: 3 }}>
            ...
            <Box sx={{ my: 2, pl: 0, }}>
              ...
              <Typography variant="body2">
                This Shipping & Delivery Policy is part of our Terms of Use (&quot;Terms&ldquo;) and should be therefore read alongside our main Terms:
              </Typography>
              <Typography variant="body2">
